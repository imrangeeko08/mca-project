      ...
      <div className="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="300">
        <div className="team-item p-4">
          ...
          <div className="btn-slide mt-1">
            <i><FaShare /></i>
            <span>
              <a href="https://www.facebook.com/johndoe" aria-label="Facebook">
                <i><FaFacebookF /></i>
              </a>
              <a href="https://twitter.com/johndoe" aria-label="Twitter">
                <i><FaTwitter /></i>
              </a>
              <a href="https://www.instagram.com/johndoe" aria-label="Instagram">
                <i><FaInstagram /></i>
              </a>
            </span>
          </div>
      ...
      <div className="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="500">
        <div className="team-item p-4">
          ...
          <div className="btn-slide mt-1">
            <i><FaShare /></i>
            <span>
              <a href="https://www.facebook.com/janesmith" aria-label="Facebook">
                <i><FaFacebookF /></i>
              </a>
              <a href="https://twitter.com/janesmith" aria-label="Twitter">
                <i><FaTwitter /></i>
              </a>
              <a href="https://www.instagram.com/janesmith" aria-label="Instagram">
                <i><FaInstagram /></i>
              </a>
            </span>
          </div>
      ...
      <div className="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="700">
        <div className="team-item p-4">
          ...
          <div className="btn-slide mt-1">
            <i><FaShare /></i>
            <span>
              <a href="https://www.facebook.com/samuellee" aria-label="Facebook">
                <i><FaFacebookF /></i>
              </a>
              <a href="https://twitter.com/samuellee" aria-label="Twitter">
                <i><FaTwitter /></i>
              </a>
              <a href="https://www.instagram.com/samuellee" aria-label="Instagram">
                <i><FaInstagram /></i>
              </a>
            </span>
          </div>
      ...
      <div className="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="900">
        <div className="team-item p-4">
          ...
          <div className="btn-slide mt-1">
            <i><FaShare /></i>
            <span>
              <a href="https://www.facebook.com/oliviabrown" aria-label="Facebook">
                <i><FaFacebookF /></i>
              </a>
              <a href="https://twitter.com/oliviabrown" aria-label="Twitter">
                <i><FaTwitter /></i>
              </a>
              <a href="https://www.instagram.com/oliviabrown" aria-label="Instagram">
                <i><FaInstagram /></i>
              </a>
            </span>
          </div>
